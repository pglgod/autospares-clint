            ...
            <div className="nav-links">
                <ul className="nav-list flex align-c">
                    ...
                    <li className="nav-list-item">
                        <Link to="/seller.dashboard" className={location.pathname === "/seller.dashboard" ? "active-brad": "desabled-brad" && location.pathname === "/seller.dashboard/add_product" ? "active-brad": "desabled-brad" && location.pathname === "/seller.dashboard/recived_orders" ? "active-brad": "desabled-brad" }>
                            Seller Dashboard
                        </Link>
                    </li>
                </ul>
